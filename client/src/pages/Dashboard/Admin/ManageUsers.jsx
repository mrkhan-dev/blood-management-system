                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-white">
                    ...
                    <tr>
                      <th
                        scope="col"
                        className="px-12 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-700"
                      >
                      ...
                      <th
                        scope="col"
                        className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-700 "
                      >
                        <button className="flex items-center gap-x-2">
                          <span>Role</span>
